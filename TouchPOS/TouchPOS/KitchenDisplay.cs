                ...
                foreach (DataRow dr in KitTable.Rows) 
                {
                    ...
                    if (PageTable.Rows.Count > 0)
                    {
                        foreach (DataRow dr1 in PageTable.Rows) 
                        {
                            i++;
                            Panel Pnl = new Panel();
                            ShowOrder objForm = new ShowOrder();
