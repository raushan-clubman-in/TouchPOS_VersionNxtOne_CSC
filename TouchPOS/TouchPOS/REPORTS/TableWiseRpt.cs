...
{
    public partial class TableWiseRpt : Form
    {
        ...
        private void TableWiseRpt_Load(object sender, EventArgs e)
        {
            BlackGroupBox();
            FillPosLocations();
        ...
        private void btn_view_Click(object sender, System.EventArgs e)
        {
            ...
            CRYSTAL.TablewiseReport RPS = new CRYSTAL.TablewiseReport();
            POSNAME = "";
            string SSQL;
            ...
            sqlstring = "select Isnull(TABLENO,'') as TABLENO,Isnull(ServerName,'') as SCODE,Isnull(POSDESC,'') as POSCODE,sum(amount) as Amount from POSWISESALES  ";
            ...
            sqlstring = sqlstring + " group by TABLENO,ServerName,POSDESC Order By POSDESC,TABLENO ";
