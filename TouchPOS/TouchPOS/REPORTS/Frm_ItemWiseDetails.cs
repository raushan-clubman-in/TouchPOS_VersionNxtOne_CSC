...
{
    public partial class Frm_ItemWiseDetails : Form
    {
        GlobalClass GCon = new GlobalClass();

        public Frm_ItemWiseDetails()
        {
            InitializeComponent();
        }

        private void Frm_ItemWiseDetails_Load(object sender, EventArgs e)
        {
            BlackGroupBox();
            FillPosLocations();
        ...
        private void btn_view_Click(object sender, EventArgs e)
        {
            ...
            CRYSTAL.ItemWiseDetails RPS = new CRYSTAL.ItemWiseDetails();
            POSNAME = "";
            string SSQL;
            ...
            sqlstring = "select ITEMCODE,ITEMDESC,UOM,sum(qty) as Qty,sum(AMT) as Amount,SUM(CGST+SGST+CESS) AS TAXAMOUNT,SUM(SCHARGE+PACKAMOUNT+ACHARGE) AS PACKAMT from VIEWITEMWISESALESUMMARY_JIC  ";
            ...
            sqlstring = sqlstring + "  GROUP BY ITEMCODE,ITEMDESC,UOM ";
